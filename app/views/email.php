        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 20px; padding: 20px 0 30px 0;">     
              Cameron, Thank you for subscribing to your newsletter  
            </td>
          </tr>
          <tr>
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
           <tr>
             <td style="color: #eee;" width="75%">
               ...
               Winnipeg, MB, 2015<br/>
               <a style="color: #fff;"href="http://50.71.84.193/api/Subscription/unsubscribe/cameron.hrycyna@gmail.com">Unsubscribe</a> to this newsletter.
             </td>
             <td align="right">
